...
public class CubeInstantiate : MonoBehaviour
{
    ...
    void Start()
    {
        GameObject obj = Instantiate(myPrefabBlue, new Vector3(-3.816f, 3.3f, -3.44f), Quaternion.Euler(0f, 0.962f, 0f));
        obj.transform.parent = GameObject.Find("base").transform;
    }

    public void InstantiateRed()
    {
        GameObject obj = Instantiate(myPrefabRed, new Vector3(-3.816f, 3.3f, -3.44f),Quaternion.Euler(0f, 0.962f, 0f));
        obj.transform.parent = GameObject.Find("base").transform;
    }

    public void InstantiateGreen()
    {
        GameObject obj = Instantiate(myPrefabGreen, new Vector3(-3.816f, 3.3f, -3.44f),  Quaternion.Euler(0f, 0.962f, 0f));
        obj.transform.parent = GameObject.Find("base").transform;
    }
